...
class RetrainingScheduler:
    ...
    def check_performance(self):
        ...
        try:
            ...
            if housing_perf.get('needs_retraining', False):
                logger.warning("Housing model performance degraded, retraining recommended")
            
            if iris_perf.get('needs_retraining', False):
                logger.warning("Iris model performance degraded, retraining recommended")
    ...
    def run_retraining(self, model_type: Optional[str] = None, force: bool = False) -> Dict:
        ...
        try:
            logger.info(f"Starting retraining pipeline (model_type={model_type}, force={force})")
...
async def health_check():
    ...
    return {
        ...
        'scheduler_running': scheduler.schedule_thread is not None and scheduler.schedule_thread.is_alive()
    }
