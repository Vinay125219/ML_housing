...
def retrain_iris_model(new_data_path=None):
    """
    Retrain the iris classification model with new data
    """
    try:
        ...
        if new_data_path and os.path.exists(new_data_path):
            ...
            print("🔄 Loading existing iris data")
        ...
        with open("../iris_retrain_results.json", "w") as f:
